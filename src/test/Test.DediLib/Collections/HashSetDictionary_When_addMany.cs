...
namespace Test.DediLib.Collections
{
    ...
    public class HashSetDictionary_When_addMany
    {
        ...
        public HashSetDictionary_When_addMany()
        {
        ...
        public void If_addMany_with_key_and_no_values_Then_count_and_values_match()
        {
            ...
            Assert.Empty(_sut.GetValues(1).ToArray());
            Assert.Empty(_sut.GetValuesAsHashSet(1).ToArray());
            Assert.Empty(_sut.Keys.ToArray());
            Assert.Empty(_sut.Values.ToArray());
        }
        ...
        public void If_addMany_with_same_key_and_same_values_Then_count_and_values_match()
        {
            ...
            Assert.Equal(new[] { 1000 }, _sut.GetValuesAsHashSet(1).ToArray());
        ...
        public void If_addMany_with_same_key_and_different_values_Then_count_and_values_match()
        {
            ...
            Assert.Equal(new[] { 1000, 2000 }, _sut.GetValuesAsHashSet(1).ToArray());
            Assert.Equal(new[] { 1 }, _sut.Keys.ToArray());
        ...
        public void If_addMany_twice_with_same_key_and_different_values_Then_count_and_values_match()
        {
            ...
            Assert.Equal(new[] { 1000, 2000, 3000 }, _sut.GetValuesAsHashSet(1).ToArray());
            Assert.Equal(new[] { 1 }, _sut.Keys.ToArray());
